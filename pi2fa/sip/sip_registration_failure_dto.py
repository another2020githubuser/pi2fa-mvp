'''Data Transfer Object.  Carries info about SIP Registration failure'''
import logging
...
class SipRegistrationFailureDto:
    ...
    def __str__(self):
        return_value = "account_id = {0}\naccount_uri = {1}\nstatus = {2}, reason = {3}, code = {4}".format(
            self._account_id, self._account_uri, self._status, self._reason, self._code
        )
