...
class Buddy(pj.Buddy):
    ...
    def __repr__(self):
        ...
        return "uri: {0}, status: {1}, subStateName: {2}, subTermReason: {3}, account_id = {4}".format(
            buddy_info.uri, buddy_info.presStatus.statusText, buddy_info.subStateName, buddy_info.subStateName, self.sip_account.getId())
